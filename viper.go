...
import (
	...
	"github.com/MullionGroup/viper/internal/encoding"
	"github.com/MullionGroup/viper/internal/encoding/dotenv"
	"github.com/MullionGroup/viper/internal/encoding/ini"
	"github.com/MullionGroup/viper/internal/encoding/javaproperties"
	"github.com/MullionGroup/viper/internal/encoding/json"
	"github.com/MullionGroup/viper/internal/encoding/toml"
	"github.com/MullionGroup/viper/internal/encoding/yaml"
)
...
func Reset() {
	v = New()
	SupportedExts = []string{"json", "toml", "yaml", "yml", "properties", "props", "prop", "tfvars", "dotenv", "env", "ini"}
	SupportedRemoteProviders = []string{"etcd", "etcd3", "firestore"}
}
...
var SupportedExts = []string{"json", "toml", "yaml", "yml", "properties", "props", "prop", "tfvars", "dotenv", "env", "ini"}

// SupportedRemoteProviders are universally supported remote providers.
var SupportedRemoteProviders = []string{"etcd", "etcd3", "firestore"}
...
func (v *Viper) unmarshalReader(in io.Reader, c map[string]interface{}) error {
	...
	case "yaml", "yml", "json", "toml", "tfvars", "ini", "properties", "props", "prop", "dotenv", "env":
...
func (v *Viper) marshalWriter(f afero.File, configType string) error {
	c := v.AllSettings()
	switch configType {
	case "yaml", "yml", "json", "toml", "tfvars", "ini", "prop", "props", "properties", "dotenv", "env":
...
func (v *Viper) getKeyValueConfig() error {
	if RemoteConfig == nil {
		return RemoteConfigError("Enable the remote features by doing a blank import of the viper/remote package: '_ github.com/MullionGroup/viper/remote'")
	}
